...
<template>
    <div class="container">
        ...
        <div class="btnContainer">
            <button class="btnRetry" @click="router.go(-1)">다시 입력</button>
            <button class="btnCompleted" @click="router.replace('/inputtransfer/' + concertId)">전송</button>
        </div>
